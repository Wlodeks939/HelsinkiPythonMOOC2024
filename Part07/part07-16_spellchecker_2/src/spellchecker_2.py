...
#entrada = "We use ptython to make a spell checker"
...
print("suggestions:") 
for error in lista_errores:
        lista_sugerencias = get_close_matches(error,lista_str)
        print(f"{error}: {lista_sugerencias[0]}, {lista_sugerencias[1]}, {lista_sugerencias[2]}")
